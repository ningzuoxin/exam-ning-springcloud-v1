...
@FeignClient(contextId = "remoteUserService", value = ServiceNameConstants.USER_SERVICE, fallbackFactory = RemoteUserIndexFallbackFactory.class)
public interface RemoteUserService {
    ...
    Result<User> selectUserByUsername(@RequestParam String username);
