...
public class ExamModuleCodeGenerator {
    ...
    private static final String MODULE = "/exam-ning-springcloud-system-exam";

    private static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/exam-ning-springcloud-exam?autoReconnect=true&useUnicode=true&characterEncoding=utf8";
