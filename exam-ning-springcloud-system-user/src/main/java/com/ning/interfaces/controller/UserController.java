...
public class UserController {
    ...
    public Result<UserDTO> get(@RequestParam(value = "username") @Parameter(name = "username", example = "admin") String username) {
    ...
    @GetMapping(value = "/{id}")
    public Result<UserDTO> get(@PathVariable(value = "id") @Parameter(name = "id", example = "1") Long id) {
