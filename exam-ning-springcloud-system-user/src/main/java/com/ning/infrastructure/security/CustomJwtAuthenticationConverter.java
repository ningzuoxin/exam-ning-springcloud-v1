...
public class CustomJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        String uid = jwt.getClaimAsString(CommonConstants.JWT_UID);
        String uname = jwt.getClaimAsString(CommonConstants.JWT_SUB);
        List<String> permissions = jwt.getClaimAsStringList(CommonConstants.JWT_PERMISSIONS);
